-- Schema SQL adaptado para Supabase
-- REMOVE as linhas de criação de roles/permissões que o Supabase já gerencia
...
-- NOTA: No Supabase, as permissões e roles são gerenciadas automaticamente
-- Não é necessário criar roles ou permissões manualmente
